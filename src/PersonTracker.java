...
/**
 * PersonTracker maintains a HashMap of current tracking ID and body pose data.  It also
 * maintains sets of new tracking IDs (enters) and IDs not longer being tracked (exits).  
 * PersionTracker update should be called every frame with new tracknig data. 
 * 
 * @author eitan
 *
 */
public class PersonTracker {
	...
	/**
	 * @return returns a Set of Track IDs of people who entered the space during the most 
	 * recent call to update.  Any ID in enter set will also be in HashMap returned by getPeople.
	 */
	...
	/**
	 * @return returns a Set of Track IDs of people who exited the space during the most 
	 * recent call to update.  Any ID in exit set will not be in HashMap returned by getPeople.
	 */
	 ...
	 * for people of people currently in the space.
	 */
	...
	/**
	 * update should be called every frame.  It compares current tracking information to 
	 * tracking information from the last frame and generates enters, exits, and people.
	 * 
