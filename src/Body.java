...
/**
 * Body represents a single tacked skeleton
 * Use this class to access skeleton data
 * @author eitan
 *
 */
public class Body {
	...
	/**
	 * get track id.  These should remain consistant between frames (where body numer in the list may not)
	 * @return
	 */
	public long getId() {
		return id;
	 ...
	 * @param jointName
	 * @return a quaternion representing the joint's absolute rotation and orientation
